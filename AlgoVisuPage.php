...
<div class="row">
    <div class="col-sm-4">
        <div class="dropup">
            <button class="btn btn-sm btn-primary dropdown-toggle" type="button" id="actionsdropup" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"><i class="fa fa-bars"></i></button>
            <ul class="dropdown-menu" id="actionsdropup-list" aria-labelledby="actionsdropup"></ul>
        </div>
    </div>
    <div class="col-sm-8">
        <div id="controls-area" class="text-center1">
            <div class="player">
                <button type="button" id="button_fbw" class="btn btn-sm btn-rose btn-simple1" onclick="buttonRewindPress()"><i class="fa fa-fast-backward"></i></button>
                <button type="button" id="button_bw" class="btn btn-sm btn-dribbble btn-simple1" onclick="buttonBackPress()"><i class="fa fa-backward"></i></button>
                <button type="button" id="button_play" class="btn btn-sm btn-facebook btn-simple1" onclick="buttonPlayPress()"><i class="fa fa-play"></i></button>
                <button type="button" id="button_stop" class="btn btn-sm btn-youtube btn-simple1" onclick="buttonStopPress()"><i class="fa fa-stop"></i></button>
                <button type="button" id="button_fw" class="btn btn-sm btn-twitter btn-simple1" onclick="buttonForwardPress()"><i class="fa fa-forward"></i></button>
                <button type="button" id="button_ffw" class="btn btn-sm btn-linkedin btn-simple1" onclick="buttonFastforwardPress()"><i class="fa fa-fast-forward"></i></button>
            </div>
        </div>
    </div>
</div>
